...
*/
func (a *ChartRepositoryApiService) ChartrepoChartsPost(ctx context.Context, chart string, prov string) (*http.Response, error) {
	var (
...
@return Array
*/
func (a *ChartRepositoryApiService) ChartrepoRepoChartsNameGet(ctx context.Context, repo string, name string) (Array, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ChartRepositoryApiService) ChartrepoRepoChartsNameVersionGet(ctx context.Context, repo string, name string, version string) (ChartVersionDetails, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ChartRepositoryApiService) ChartrepoRepoChartsNameVersionLabelsGet(ctx context.Context, repo string, name string, version string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ChartRepositoryApiService) ChartrepoRepoChartsNameVersionLabelsIdDelete(ctx context.Context, repo string, name string, version string, id int32) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ChartRepositoryApiService) ChartrepoRepoChartsNameVersionLabelsPost(ctx context.Context, body Label, repo string, name string, version string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ChartRepositoryApiService) ChartrepoRepoChartsPost(ctx context.Context, chart string, prov string, repo string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ChartRepositoryApiService) ChartrepoRepoProvPost(ctx context.Context, prov string, repo string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
